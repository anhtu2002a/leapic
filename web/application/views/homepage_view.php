            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-md">
                    <div class="wellcome-heading">
                        <h2>LeaPic</h2>
                        <h3>L</h3>
                        <p>The best way to Learn English by Picture</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>Easy to Learn</h4>
                        <p>We built pretty complete App that's help you to improve your Foreign Language<n/p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.4s">
                        <div class="single-icon">
                            <i class="ti-book -pencil" aria-hidden="true"></i>
                        </div>
                        <h4>Diverse Lesson</h4>
                        <p>We have diverse lesson and test per lesson for anyone</p>
                    </div>
                </div>
                <!-- Single Special Area -->
                <div class="col-12 col-md-4">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h4>Competition</h4>
                        <p>You can versus with your friend or other member to know your level</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="<?php echo base_url(); ?>img/bg-img/special.png" alt="">
                        </div>
                    </div>
    ...
    <div class="video-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url(<?php echo base_url(); ?>img/bg-img/video.jpg);">
                        <div class="video-play-btn">
                            <a href="https://www.youtube.com/watch?v=f5BBJ4ySgpo" class="video_btn"><i class="fa fa-play" aria-hidden="false"></i></a>
                        </div>
                    </div>
                </div>
            </div>
