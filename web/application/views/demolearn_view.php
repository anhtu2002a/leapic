                    ...
                    <div class="card-block col-md-12 col-lg-5 rounded" style="background-color: #CFE2E8">
                        <div>
                            ...
                            <div id="Learn_vol" class="text-center">
                                <span name="Volcabulary" id="Volcabulary" class="Volcabulary" style="font-weight: bold; font-size: 30px; font-family:sans-serif;">Chicken</span>
                                <br>
                                <span name="Mean" id="Mean" class="Mean" style="font-weight: bold; font-size: 30px; font-family:sans-serif;">Thịt Gà</span>
                            </div>
                            <div id="Learn-Ex" class="text-center" style="font-family: ">
                                <a href="" id="View_Example" class="card-block col-md-12 col-lg-12">Xem Ví Dụ</a>
                            </div>
                        </div>
                    </div>    
                </div>       
